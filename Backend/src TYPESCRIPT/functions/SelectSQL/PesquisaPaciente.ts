...
async function PesquisaPaciente(nomePaciente: string, numProntuario: string, numRegulacao: string, statusRegulacao: string) {
    ...
    try {
        ...
        let queryParams: (string | number)[] = []; // Array para os parâmetros da query
