...
/*IMPORT INTERFACES*/
import { TransporteData } from "../../Interfaces/Transporte.js";

async function saveTransporte(FormData: TransporteData) {
    ...
    try {
        ...
        // Usuário tem permissão, insere os dados no banco
